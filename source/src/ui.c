...
void ui_on_key(bool down, u32 key_code) {
    ...
    case SDLK_a: gamepad_get_state()->a = down; break;
    case SDLK_s: gamepad_get_state()->start = down; break;
    case SDLK_d: gamepad_get_state()->select = down; break;
    case SDLK_i: gamepad_get_state()->up = down; break;
    case SDLK_k: gamepad_get_state()->down = down; break;
    case SDLK_j: gamepad_get_state()->left = down; break;
    case SDLK_l: gamepad_get_state()->right = down; break;
    }

    if (down) {
        u8 flags = cpu_get_int_flags();
        cpu_set_int_flags(flags | 0x10);
